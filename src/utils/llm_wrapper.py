    ...
    def generate_cli(
        ...
        **kwargs: Any
        ...
        try:
            ...
            # Some OpenAI-hosted models only support the default temperature (1).
            # Keep temperature=0 behavior for local OpenAI-compatible servers.
            base_url = str(llm_config_dict.get("base_url", "")).lower()
            if "openai.com" in base_url and temperature == 0:
                temperature = 1
